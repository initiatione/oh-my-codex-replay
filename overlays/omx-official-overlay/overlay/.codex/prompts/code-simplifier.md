...
5. **Best Result Within Scope**: Optimize for the clearest and most maintainable resulting code inside the approved simplification scope. Treat smaller diffs and fewer lines as heuristics, not as the goal.

6. **Focus Scope**: Only refine code that has been recently modified or touched in the
